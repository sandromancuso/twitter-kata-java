...
public class PostingAndReadingSteps {
	...
	public void alice_posts_a_few_messages() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@When("^Bob reads Alice's messages$")
	public void bob_reads_Alice_s_messages() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}

	@Then("^Alice's messages are displayed in reverse chronological order$")
	public void alice_s_messages_are_displayed_in_reverse_chronological_order() throws Throwable {
		// Write code here that turns the phrase above into concrete actions
		throw new PendingException();
	}
}
